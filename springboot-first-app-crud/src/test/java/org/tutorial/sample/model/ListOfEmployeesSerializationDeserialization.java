...
public class ListOfEmployeesSerializationDeserialization {
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ListOfEmployeesSerializationDeserialization loe=new ListOfEmployeesSerializationDeserialization();
        loe.createListOfEmployeesJSONArrayFromEmployeePOJOClass();
        loe.getPojoFromEmployeeObject();
    }
}